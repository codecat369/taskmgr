...
var Chart = function () {
    ...
    Chart.prototype.combineChartConfig = function (props, config) {
        var chartRetain = ['height', 'width', 'animate', 'forceFit', 'background', 'plotBackground', 'padding', 'theme', 'onMouseDown', 'onMouseMove', 'onMouseUp', 'onClick', 'onDbClick', 'onTouchStart', 'onTouchMove', 'onTouchEnd', 'onPlotEnter', 'onPlotMove', 'onPlotLeave', 'onPlotClick', 'onPlotDbClick'];
    ...
    Chart.prototype.combineContentConfig = function (displayName, props, config) {
        ...
        var regSeries = ['pie', 'sector', 'line', 'smoothLine', 'dashLine', 'area', 'stackArea', 'smoothArea', 'bar', 'stackBar', 'dodgeBar', 'interval', 'stackInterval', 'dodgeInterval', 'point', 'funnel', 'pyramid', 'schema', 'box', 'candle', 'polygon', 'contour', 'heatmap', 'edge', 'sankey', 'errorBar', 'jitterPoint', 'path'];
        ...
        if (rerender) {
            ...
            this.context.timer = setTimeout(function () {
                if (_this.context.chart) {
                    ...
                    _this.context.chart = (0, _viser2.default)(_this.context.config);
                }
            }, 90);
            ...
            this.context.chart = (0, _viser2.default)(this.context.config);
        }
    };
    Chart.decorators = [{ type: _core.Component, args: [{
            providers: [_chartService.ChartContext],
            selector: 'v-chart',
            template: "<div #chartDom></div>"
        }] }];
    Chart.ctorParameters = function () {
        return [{ type: _chartService.ChartContext }, { type: _core.ElementRef }, { type: _core.ViewContainerRef }];
    };
    Chart.propDecorators = {
        ...
        plotBackground: [{ type: _core.Input }],
